...
const LinkPreview = ({ preview, handlePreviewRemove }) => {
    return (
        <div className="flex flex-col w-full relative">
            <CloseModalIcon onClick={handlePreviewRemove} className="z-index-2 absolute t-2 r-2 w-7 h-7 stroke-grey cursor-pointer bg-grey-dark-light p-2 br-50 hover:bg-dark-3 z-index-1" />
